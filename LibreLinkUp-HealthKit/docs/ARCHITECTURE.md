...
LibreLinkUp HealthKit is a SwiftUI macOS application following a service-oriented architecture. The app has three layers: views, a sync orchestrator, and service modules.
